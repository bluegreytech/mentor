...
<!--CSS-->
<link rel="stylesheet" href="asset/all-css/my-sets/css/all.css">
<link href="asset/all-css/my-sets/css/global-plugins.css" rel=stylesheet>
<link href="asset/all-css/my-sets/css/my-styles6f92.css?20190422" rel=stylesheet>
<link href="asset/all-css/my-sets/css/my-media6687.css?20190318" rel=stylesheet>
<link href="asset/all-css/my-sets/css/lightslider.css" rel=stylesheet>
...
<body>
  ...
  <header>
            ...
            <div class="container" >
                <div class="row" >
                  <div class="col-md-12 right">
                     ...
                     <a href="about-us.php" style="">About Us</a>
                     <a target="_blank" href="schools.php">Mentoring at School</a>
                     <a href="contact-us.php" style="">Contact Us</a>
            ...
            <div class="container" >
               <div class="row" >
                  <div class="col-md-2 left">
                     <a href="index.php">
                     <img src="images/home/mentor-big-bluec6eb.png?w=300" class="logo-blue logo-desktop"  >
                      ...
                      <div class="sub-products with-tabs ">
                        <div class="col-md-2 col-left">
                          <ul class="menu-dropdown-tabs">
                            <li class="active">
                              <span class="icons">
                                <img src="asset/images/tabsicon-1a.png" class="gray">
                                <img src="asset/images/tabsicon-1b.png" class="white">
                              </span>
                              Career Counselling 
                              <br>Programs
                            ...
                            <li>
                              <span class="icons">
                                <img src="asset/images/tabsicon-2a.png" class="gray" style="width:30px">
                                <img src="asset/images/tabsicon-2b.png" class="white" style="width:30px">
                              </span>
                            ...
                            <li>
                              <span class="icons">
                                <img src="asset/images/tabsicon-3a.png" class="gray" style="width:31px">
                                <img src="asset/images/tabsicon-3b.png" class="white" style="width:31px">
                              </span>
                             Mentoring at School
                              <i class="fa fa-caret-left"></i>
                            </li>
                            <li>
                              <span class="icons">
                                <img src="asset/images/tabsicon-4a.png" class="gray" style="width:27px">
                                <img src="asset/images/tabsicon-4b.png" class="white" style="width:27px">
                              </span>
                              Budding Carrer
                              <br>Counsellors
                              <i class="fa fa-caret-left"></i>
                  ...
                  <div class="col-md-10 col-right">
                    ...
                    <div class="menu-tabdetails">
                     ...
                     <a href="success-stories.php" >Success Stories<span class="active-line"></span></a>
                     ...
                     <a href="pricing.php" >Pricing<span class="active-line"></span></a>
                     <a href="login.php" >Log In<span class="active-line"></span>
                    </a>
      ...
      <div class="mobile-fixed-header-menu">
         ...
         <div class="col-md-12 ">
            <a href="index.php">
            <img src="images/tinyimg/mentor-big-bluec6eb.png?w=300" class="logo-blue" style="max-width: 166px;margin-top: -4px;">
            </a>
         </div>
         <div class="col-md-12 ">
            <div class="call-link">
