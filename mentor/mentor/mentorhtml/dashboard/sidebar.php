         ...
         <div id="sidebar" class="nav-collapse md-box-shadowed">
            ...
            <div class="leftside-navigation leftside-navigation-scroll">
               <ul class="sidebar-menu" id="nav-accordion">
                  <li class="sidebar-profile" >
                     <div class="profile-main">
                        <div class="img-blue-box">
                           <p class="image">
                              <img id="sidebar-image" src="../images/a6.png" />                              <!-- <span class="status"><i class="fa fa-circle text-success"></i></span> -->
                           </p>
                        </div>
                        <p>
                  ...
                  <li id="tour1"><a href="index.php" class="active"><span class="icon-home2 fa fa-home"></span><span class="nav-title">Dashboard</span></a>
                  </li>
                  <li id="tour2"><a href="profileview.php" ><span class="icon-home2 fa fa-user"></span><span class="nav-title">My Profile</span></a>
                  </li>
