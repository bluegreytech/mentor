        ...
        <div class="head-2">
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    <h1>Career Counselling Programs for Class 9<sup>th</sup> - 10<sup>th</sup></h1>
                    <!--p>Nurturing Minds</p-->
                </div>
            </div>
        </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              <li>Identify your likes and dislikes and how it impacts your preferences and lifestyle. Learn to enhance your strength and develop assertiveness.</li>
                                              <li>Understanding the subjective definition of your Career.</li>
                                              <li>Bringing your passions and hobbies on the table.</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6"><img src="images/2.jpg" class="img-responsive"></div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              <li>Understand your profile better through personalised and comprehensive report. </li>
                                              <li>Learn about your individualised interests, career values & motivators, personality, learning style, skills and abilities by our expert career Mentor.</li>
                                              <li>Get a Career road map for pursuing further education and career opportunities.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              <li>Get rid of the confusions and manage the journey of your career with a full-proof plan. </li>
                    ...
                    <div class="pg-contact">
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="price-item text-center">
                            <img src="images/icon/p1.png" alt="pricing-img">
                            <h3>PREVIEW</h3>
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="price-item text-center">
                            <img src="images/icon/p2.png" alt="pricing-img">
                            <h3>LEARN</h3>
                            <span class="cl">Perfect Choice For Individual</span>
                            <div class="price-tag">
                                <span><sup>$</sup>25</span>
                      ...
                      <div class="col-lg-4 col-sm-6">
                        <div class="price-item text-center">
                            <img src="images/icon/p3.png" alt="pricing-img">
                            <h3>EXPLORE</h3>
                            <span class="cl">Perfect Choice For Individual</span>
                            <div class="price-tag">
                                <span><sup>$</sup>25</span>
                    ...
                    <div class="pg-contact">
                        ...
                        <div class="row">
                          <div class="col-md-6" style="padding: 0">
                                  ...
                                  <div class="s17-eve-time">
                                      <div>
                                        <h4>I am in 9th grade, how will Career Counseling help me?</h4>
                                        <p>You have entered in a class where thinking about Career options can lead to a lot of confusion. The first priority then becomes to ace the examination. With the help of career counseling, you will not only get a career road map but you will also get acquainted with your learning style.</p>
                                      </div>
                                  </div>
                                  <div class="s17-eve-time">
                                      <div>
