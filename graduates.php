                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              <li>Understanding your subjective importance of career.</li>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              <li>Benefit from personal career profiling.</li>
                                              <li>Narrow down your occupational choices based on your assessment.</li>
                                              <li>Benefit from customised road map for pursuing further education and career opportunities. </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              <li>Get your hands on customized action plan for your career development. </li>
                                              <li>Get expert advice from every angle on higher education.</li>
                    ...
                    <div class="pg-contact">
                        ...
                        <div class="row">
                          <div class="col-md-6" style="padding: 0">
                                  ...
                                  <div class="s17-eve-time">
                                      <div>
                                        <h4>Will Career Counseling help me decide which college to opt? </h4>
                                        <p>Yes, definitely! Early Career Counseling before stepping into the professional world or into the world of advanced studies will help you plan your career in a more proactive and effective way.</p>
                                      </div>
                                  </div>
                                  <div class="s17-eve-time">
                                      <div>
                                        <h4> I reside outside Gujarat. How do I avail your services?</h4>
                                        <p>Our services are available across India. For effective Career Counseling session we have facilities of Skype, hangouts or any other face to face video calling medium. We can fix an appointment at your convenience. </p>
                                      </div>
                                  </div>
                                  <div class="s17-eve-time">
                                      <div>
