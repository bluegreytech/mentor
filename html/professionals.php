        ...
        <div class="head-2">
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    <h1>Career Counselling Programs for Professionals</h1>
                    <!--p>Nurturing Minds</p-->
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              ...
                                              <li>Tracking your likes and dislikes and how it impacts your preferences and lifestyle.</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              ...
                                              <li>Get your career choice that is in-line with our core beliefs and values for a lasting and positive choice.</li>
                                              <li>Narrow down your occupational choices based on your assessment. </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <ul>
                                              ...
                                              <li>Resolve all the prevailing queries and doubts. </li>
                    ...
                    <div class="pg-contact">
                        ...
                        <div class="row">
                          <div class="col-md-6" style="padding: 0">
                                  ...
                                  <div class="s17-eve-time">
                                      <div>
                                        <h4>How will Career Counseling help me at a professional level?</h4>
                                        <p>Career Counseling will help you identify your current career profile. It will assist you to deal with setbacks by the means of resilience with an effective road map. Midlife crisis can lead to anxiety and we promise to hold your hand to overcome for a better and successful life.</p>
                                      </div>
                                  </div>
                                  <div class="s17-eve-time">
                                      <div>
                                        <h4>Will Career Counseling help me in my existing profession?</h4>
                                        <p>Definitely, after analysing your profession and your experience we will trace down opportunities that best fits your personality. We believe in aligning your passion with your career for a satisfactory life.</p>
                                      </div>
                                  </div>
                                  <div class="s17-eve-time">
                                      <div>
