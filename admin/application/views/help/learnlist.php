    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?php echo base_url();?>Help/addlearn/" class="btn btn-primary" style="float:right">Add learn</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $i; ?></td>                                   
                                    <td><?php echo $row->learn_title; ?></td>
                                     <td><?php echo $row->program_title; ?></td>
                                   <td>
                                        <img src="<?php echo base_url();?>upload/helpimg/<?php echo $row->learn_img;?>" class="img-thumbnail border-0" style="height: 50px;width:50px;">
                                    </td>
                                    ...
                                    <td>
                                      <?php echo anchor('Help/editlearn/'.$row->lid,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a href="javascript:void(0)" onclick="deletedata('<?php echo $row->lid; ?>')" ><i class="ficon icon-bin"></i></a>     
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
