    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Key Highlights
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="<?php echo base_url();?>Help/addkey/" class="btn btn-primary" style="float:right">Add Highlights</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $i; ?></td>                                   
                                    <td><?php echo $row->key_title; ?></td>
                                    <td><?php echo $row->program_title; ?></td>
                                   <td>
                                        <img src="<?php echo base_url();?>upload/helpimg/<?php echo $row->key_img;?>" class="img-thumbnail border-0" style="height: 50px;width:50px;">
                                    </td>
                                    ...
                                    <td>
                                      <?php echo anchor('Help/editkey/'.$row->key_id,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a href="javascript:void(0)" onclick="deletedata('<?php echo $row->key_id; ?>')" ><i class="ficon icon-bin"></i></a>     
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
