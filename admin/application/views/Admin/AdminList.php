    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?php echo base_url();?>home/addadmin/" class="btn btn-black" style="float:right">Add Admin</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <?php echo anchor('home/Editadmin/'.$admin->AdminId,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a href="javascript:void(0)"  onclick="deletedata('<?php echo $admin->AdminId; ?>','<?php echo $admin->ProfileImage;?>')" ><i class="ficon icon-bin"></i></a>    
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
...
function deletedata(id,image){  
    $('#myModal').modal('show')
        ...
        $('#yes_btn').click(function(){           
                ...
                $.ajax({
                url: url+"/home/deletedata/",
                type: "post",
                data: {id:id} ,
                success: function (response) {             
                document.location.href = url+'home/adminlist';                  
