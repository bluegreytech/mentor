    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Programs
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <!-- <a href="<?php echo base_url();?>Programs/addprogram/" class="btn btn-primary" style="float:right">Add Program</a> -->
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td>
                                      <?php echo anchor('Programs/editprogram/'.$row->pid,'<i class="ficon icon-pencil2"></i>'); ?>
