		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url();?>Programs/category/" class="btn btn-primary" style="float:right">Back to Category List</a>
				</div>
				</h4>
				<div class="card-body collapse in">
					<div class="card-block">
				
						<form class="form" method="post" enctype="multipart/form-data" id="form_cat" action="<?php echo base_url();?>Programs/addcat">
