    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Program SubCategory
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="<?php echo base_url();?>Programs/addsubcat" class="btn btn-primary" style="float:right">Add SubCategory</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $i; ?></td>                                   
                                    <td><?php echo $row->subcat_title; ?></td>
                                  ...
                                  <td>
                                    ...
                                    <td>
                                      <?php echo anchor('Programs/editsubcat/'.$row->subcat_id,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a href="javascript:void(0)" onclick="deletedata('<?php echo $row->subcat_id; ?>')" ><i class="ficon icon-bin"></i></a>     
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
...
function deletedata(id,image){  
    $('#myModal').modal('show')
        ...
        $('#yes_btn').click(function(){
                ...
                $.ajax({
                url: url+"Programs/subcat_delete/",
                type: "post",
                data: {id:id} ,
