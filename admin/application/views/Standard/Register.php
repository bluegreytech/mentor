		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form">Add  Standard
						...
						<form class="form" method="post" id="form_standard" action="<?php echo base_url();?>Standard/AddStandard/">                      
							...
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="FirstName" name="FirstName" minlength="2" maxlength="50">
								</div>
								<div class="form-group">
									<label>Standard</label>
								
									<input type="text" class="form-control" placeholder="LastName" name="LastName" minlength="2" maxlength="50">
								</div>
								<div class="form-group">
									<label>Standard</label>
								
									<input type="text" class="form-control" placeholder="EmailAddress" name="EmailAddress" minlength="2" maxlength="50">
								</div>
								<div class="form-group">
									<label>Standard</label>
								
									<input type="text" class="form-control" placeholder="Gender" name="Gender" minlength="2" maxlength="50">
								</div>
								<div class="form-group">
									<label>Standard</label>
								
									<input type="text" class="form-control" placeholder="Standard" name="Standard" minlength="2" maxlength="50">
								</div>
								<div class="form-group">
									<label>Standard</label>
