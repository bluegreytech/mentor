    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Partners
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="<?php echo base_url();?>About/addpartner/" class="btn btn-primary" style="float:right">Add Partners</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $i; ?></td>                                   
                                    <td><?php echo $row->partner_nm; ?></td>
                                  <td><?php echo $row->partner_desg; ?></td>
                                  <td><?php echo $row->cat_title; ?></td>
                                    ...
                                    <td>
                                      <?php echo anchor('About/editpartner/'.$row->pid,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a href="javascript:void(0)" onclick="deletedata('<?php echo $row->pid; ?>')" ><i class="ficon icon-bin"></i></a>     
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
