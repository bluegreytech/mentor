    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Contacts
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="<?php echo base_url();?>About/addcontact/" class="btn btn-primary" style="float:right">Add Contacts</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td>
                                      <?php echo anchor('About/editcontact/'.$row->cid,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a href="javascript:void(0)" onclick="deletedata('<?php echo $row->cid; ?>')" ><i class="ficon icon-bin"></i></a>     
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
