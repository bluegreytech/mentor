                                      ...
                                      <div class="navbar-container content container-fluid">
                                        <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                                          ...
                                          <ul class="nav navbar-nav float-xs-right">
                                            <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><i class="icon-user"></i><i></i></span><span class="user-name"></span></a>
                                              <div class="dropdown-menu dropdown-menu-right"><a href="<?php echo base_url();?>Login/logout" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
