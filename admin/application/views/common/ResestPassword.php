    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                ...
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Reset Password with Mentor</span></h6>
            </div>
                ...
                <div class="card-block">
                       <?php $attributes = array('name'=>'frm_reset','id'=>'frm_restpwd','class'=>'reset-form');
                        ...
                        <input type="hidden"   value="<?php echo $AdminId; ?>" name="AdminId">
                            ...
                            <input type="password" name="Password" class="form-control form-control-lg input-lg" placeholder="Password" id="Password">
                         ...
                         <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" name="Confrim_password" class="form-control form-control-lg input-lg" placeholder="Confrim password">
                             <div class="form-control-position">
                                <i class="icon-key3"></i>
                        ...
                        <fieldset class="form-group row">
                            <div class="col-md-4 col-xs-12 text-xs-center text-md-left">
                                <a href="<?php echo base_url(); ?>" name="back"  class="btn btn-primary btn-block"  role="button" >Back</a>
                            </div>
                             <div class="col-md-4 col-xs-12 text-xs-center text-md-left">
                             </div>
                            <div class="col-md-4 col-xs-12 text-xs-center text-md-right">  
                            <input type="submit" name="submit" class="btn btnlogin btn-primary btn-block" value="Submit"></div>
                        </fieldset>
                    </form>
                </div>
            </div>
