            ...
            <div class="widget-content for-upgrade">
               <div class="status-box">
                  <div class="row">
                     <div class="text-center">
                        <p class="dash-s-icon">
                          <span class="dashboard-icon-circle"><span class="fa fa-inr icons"></span></span>Payment & Report
                        </p>
                     </div>
                     <div>
                      <?php 
                      if($student_payment==''){ ?>
                        <div class="right-fixed-box">                          
                           <p class="dashboard-squre-title">Your Career Planning Report is De-activated. Make a Payment to Activate your Report.</p>
                           <div class="btn-row">
                              <a href="<?php echo base_url();?>Mytest/Test_complete/" class="btn-status">Make Payment</a>
                          </div>
                        </div>
                      <?php } else{  ?>
                        <div class="right-fixed-box">                          
                           <p class="dashboard-squre-title">Report generation is under process. to view report please come back after 6 hours .</p>
                           <div class="btn-row">
                              <a href="<?php echo base_url();?>Mytest/View_report/" class="btn-status">View Report</a>
                          </div>
                        </div>
                      <?php }?>
                     </div>
