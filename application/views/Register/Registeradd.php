...
<link href="<?php echo base_url()?>../assets/prelogin_new/css/returning.css" type="text/css" rel="stylesheet">
            ...
            <div style="float:left; width:100%">
               <div class="sign-up-box" style="position: relative;">
                  ...
                  <div class="col-md-6 social-link-facebook" style="padding-left:0; padding-right:5px">
                     ...
                     <img src="<?php echo base_url()?>assets/prelogin_new/img/facebook-icon.png"/>facebook
                     </a>
                  </div>
                  <div class="col-md-6 social-link-google"  style="padding-right:0; padding-left:5px">
                     <a href="#" class="socialbutton">
                     <img src="<?php echo base_url()?>assets/prelogin_new/img/google-icon.png"  />google
                     </a>
                  </div>
                  <div class="clear"></div>
                  <p>
