...
<!-- jS -->
 <link href="<?php echo base_url(); ?>default/asset/all-css/my-sets/css/jquery-ui.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo base_url(); ?>default/asset/all-css/my-sets/js/jquery.js" ></script>
<script type="text/javascript" src="<?php echo base_url(); ?>default/asset/all-css/my-sets/js/jquery-ui.min.js"></script>
 <script type="text/javascript" src="<?php echo base_url(); ?>default/asset/all-css/my-sets/js/bootstrap.min.js"></script>
 <script type="text/javascript" src="<?php echo base_url(); ?>default/asset/all-css/my-sets/js/custom.js"></script>
 <script type="text/javascript" src="<?php echo base_url(); ?>default/asset/all-css/my-sets/js/lightslider.js"></script>
